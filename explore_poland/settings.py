"""
Django settings for explore_poland project.
...
SECRET_KEY = 'django-insecure-z-_9(ocx(v8a^c&^q&y14oax%5n_le2+7g_u2te*7i-v4kybu1'
...
ROOT_URLCONF = 'explore_poland.urls'
...
WSGI_APPLICATION = 'explore_poland.wsgi.application'
